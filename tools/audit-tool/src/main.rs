...
async fn index() -> Html<String> {
    let html = concat!(
        ...
        ".header { display: flex; justify-content: space-between; align-items: center; padding: 10px 20px; border-bottom: 1px solid #ddd; }",
        ...
        ".view-toggle button { padding: 4px 8px; font-size: 0.8rem; margin-right: 5px; background: #f5f5f5; border: 1px solid #ddd; }",
